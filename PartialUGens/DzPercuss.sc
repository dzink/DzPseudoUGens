/**
 * An electronic percussive sound.
 */
DzPercuss : UGen {
	*ar {
		arg trigger, noise = nil, decay = 0.1, bf1Freq = 210, bf1Decay = 1, bf1Volume = 1, bf2Freq = 700, bf2Decay = 1.5, bf2Volume = 1, hfFreq = 4200, hfDecay = 1.5, hfVolume = 1, oscFreq = 60, oscSweepFreq = 20, oscDecay = 1, oscSweepDecay = 0.2, oscVolume = 1;
		var env, bf1, bf2, hf, osc, oscNote;

		// Default pink noise. Noise can be expensive to build, so give the option
		// to build once, pass into multiple UGens.
